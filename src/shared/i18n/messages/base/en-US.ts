...
export const baseEnUS = {
  ...
  "app.topbar.allRestaurants": "All restaurants",
  "app.topbar.dateRange": "Date range",
  "app.topbar.dateRangePick": "Pick a period",
  ...
  "app.preferences.color.description":
    "Petroleum blue is fixed for the brand. Customize the orange used on buttons, highlights, and charts.",
  "app.preferences.color.current": "Current color",
  "app.preferences.color.brandFixed": "Petroleum blue (brand — fixed)",
  "app.preferences.color.accentLabel": "Orca orange (buttons and highlights)",
  "app.preferences.color.reset": "Reset to default",
  "app.preferences.color.resetHint": "Platform default: petroleum blue + orange {default} for actions.",
