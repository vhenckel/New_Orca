...
import {
  ...
  SUPPLIER_RANKING,
  TRENDS_MONTHLY,
} from "@/modules/quotation/data/analyticsMocks";
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-lg font-semibold tracking-tight">{t("modules.quotation.analytics.deep.title")}</h2>
      </div>
      ...
      <Tabs defaultValue="precos" className="flex flex-col gap-4">
        <div className="rounded-xl border border-border bg-muted/30 p-1">
          <TabsList className="flex h-auto w-full flex-wrap justify-start gap-1 bg-transparent p-0">
            {(
              ...
              >
                {t(`modules.quotation.analytics.tabs.${key}`)}
              </TabsTrigger>
            ))}
          </TabsList>
        </div>
        ...
        <TabsContent value="precos" className="mt-0 flex flex-col gap-6 outline-none">
          <Card className="rounded-2xl shadow-sm">
            <CardHeader>
              <CardTitle className="text-base">{t("modules.quotation.analytics.prices.variationTitle")}</CardTitle>
              <CardDescription>{t("modules.quotation.analytics.prices.variationSubtitle")}</CardDescription>
            </CardHeader>
                    ...
                    <div className="flex min-w-0 flex-1 items-center gap-3">
                      ...
                      {row.attention ? (
                        <Badge className="shrink-0 border-amber-200 bg-amber-50 text-amber-950">
                          {t("modules.quotation.analytics.prices.attention")}
                        </Badge>
                      ) : (
        ...
        <TabsContent value="perdas" className="mt-0 outline-none">
          <Card className="rounded-2xl shadow-sm">
            <CardHeader className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <CardTitle className="text-base">{t("modules.quotation.analytics.losses.title")}</CardTitle>
                <CardDescription>{t("modules.quotation.analytics.losses.subtitle")}</CardDescription>
              </div>
              <div className="text-right">
                <p className="text-2xl font-bold text-amber-600 tabular-nums">R$ 740</p>
                <p className="text-[10px] font-medium uppercase tracking-wide text-muted-foreground">
                  {t("modules.quotation.analytics.losses.totalLabel")}
                </p>
              </div>
            </CardHeader>
            <CardContent>
              <div className="rounded-xl border border-border">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead>{t("modules.quotation.analytics.losses.colProduct")}</TableHead>
                      <TableHead className="text-right">{t("modules.quotation.analytics.losses.colPaid")}</TableHead>
                      <TableHead className="text-right">{t("modules.quotation.analytics.losses.colCheapest")}</TableHead>
                      <TableHead className="text-right">{t("modules.quotation.analytics.losses.colQty")}</TableHead>
                      <TableHead className="text-right">{t("modules.quotation.analytics.losses.colLoss")}</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
        ...
        <TabsContent value="dependencia" className="mt-0 outline-none">
          <div className="grid gap-4 lg:grid-cols-2">
            <Card className="rounded-2xl shadow-sm">
              <CardHeader>
                <CardTitle className="text-base">{t("modules.quotation.analytics.dependency.chartTitle")}</CardTitle>
              </CardHeader>
            ...
            <Card className="rounded-2xl shadow-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base">
                  ...
                  {t("modules.quotation.analytics.dependency.concentrationTitle")}
                </CardTitle>
                <CardDescription>{t("modules.quotation.analytics.dependency.concentrationHint")}</CardDescription>
              </CardHeader>
          ...
          <Card className="rounded-2xl shadow-sm">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base">
                ...
                {t("modules.quotation.analytics.ranking.title")}
              </CardTitle>
              <CardDescription>{t("modules.quotation.analytics.ranking.subtitle")}</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>{t("modules.quotation.analytics.ranking.colSupplier")}</TableHead>
                      <TableHead>{t("modules.quotation.analytics.ranking.colPrice")}</TableHead>
                      <TableHead>{t("modules.quotation.analytics.ranking.colResponse")}</TableHead>
                      <TableHead>{t("modules.quotation.analytics.ranking.colShare")}</TableHead>
                      <TableHead className="text-right">{t("modules.quotation.analytics.ranking.colScore")}</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
          ...
          <Card className="rounded-2xl shadow-sm">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base">
                ...
                {t("modules.quotation.analytics.frequency.title")}
              </CardTitle>
            </CardHeader>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex flex-col gap-0.5">
                        <CardTitle className="text-base">
                          {t("modules.quotation.analytics.abc.classTitle", { clazz: block.clazz })}
                        </CardTitle>
        ...
        <TabsContent value="categorias" className="mt-0 outline-none">
          <Card className="rounded-2xl shadow-sm">
            <CardHeader>
              <CardTitle className="text-base">{t("modules.quotation.analytics.categories.chartTitle")}</CardTitle>
            </CardHeader>
            <CardContent className="h-[320px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={categoryChart} margin={{ top: 8, right: 8, left: -12, bottom: 0 }}>
                  ...
                  <Legend />
                  <Bar dataKey="gasto" fill="hsl(221.2 83.2% 53.3%)" name={t("modules.quotation.analytics.categories.legendSpend")} radius={[4, 4, 0, 0]} />
                  <Bar dataKey="economia" fill="#22c55e" name={t("modules.quotation.analytics.categories.legendSave")} radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
            ...
            <Card className="rounded-2xl shadow-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base">
                  ...
                  {t("modules.quotation.analytics.response.avgTitle")}
                </CardTitle>
              </CardHeader>
              <CardContent className="flex flex-col gap-4">
            ...
            <Card className="rounded-2xl shadow-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base">
                  ...
                  {t("modules.quotation.analytics.response.rateTitle")}
                </CardTitle>
              </CardHeader>
      ...
      <section className="flex flex-col gap-3 border-t border-border pt-6" aria-label={t("modules.quotation.analytics.trends.sectionTitle")}>
        <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
          <Activity className="size-4 text-muted-foreground" aria-hidden />
          {t("modules.quotation.analytics.trends.sectionTitle")}
        </div>
        <div className="grid gap-4 lg:grid-cols-2">
          <Card className="rounded-2xl shadow-sm">
            <CardHeader>
              <CardTitle className="text-base">{t("modules.quotation.analytics.trends.spendTitle")}</CardTitle>
              <CardDescription>{t("modules.quotation.analytics.trends.spendSubtitle")}</CardDescription>
            </CardHeader>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={TRENDS_MONTHLY} margin={{ top: 8, right: 8, left: -12, bottom: 0 }}>
                  ...
                  <Area
                    type="monotone"
                    dataKey="gasto"
                    name={t("modules.quotation.analytics.trends.legendSpend")}
                  ...
                  <Line
                    type="monotone"
                    dataKey="economia"
                    name={t("modules.quotation.analytics.trends.legendSave")}
                    stroke="#22c55e"
                    strokeWidth={2}
                    dot={false}
                  />
                  <Line
                    type="monotone"
                    dataKey="potencial"
                    name={t("modules.quotation.analytics.trends.legendPotential")}
                    stroke="#eab308"
                    strokeWidth={2}
                    strokeDasharray="5 5"
                    dot={false}
          ...
          <Card className="rounded-2xl shadow-sm">
            <CardHeader>
              <CardTitle className="text-base">{t("modules.quotation.analytics.trends.accumulatedTitle")}</CardTitle>
            </CardHeader>
            <CardContent className="h-[280px] pt-0">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={ACCUMULATED_SAVINGS} margin={{ top: 8, right: 8, left: -12, bottom: 0 }}>
                  ...
                  <Bar
                    ...
                    fill="#22c55e"
                    radius={[4, 4, 0, 0]}
                    name={t("modules.quotation.analytics.trends.accumulatedTitle")}
                  />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
