...
export const debtNegotiationEnUS = {
  ...
  "dashboard.daily.subtitle": "Quantity per day · use pagination when the range spans more than one month",
  "dashboard.daily.subtitleValue": "Amount in BRL per day · use pagination when the range spans more than one month",
  "dashboard.daily.paginationRange": "Month {current} of {total} · {month}",
  "dashboard.daily.emptyPeriod": "No data in this period.",
